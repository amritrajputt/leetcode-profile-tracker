/**
 * Run this script to manually trigger the nightly update logic
 * Usage: npx tsx src/scripts/runCronNow.ts
 */
...
async function runNow() {
    console.log("Manually triggering nightly update...\n");
    ...
    try {
        ...
        for (const student of students) {
            console.log(`Processing: ${student.name} (${student.rollNumber})`);
            ...
            try {
                if (student.leetcodeUserName) {
                    ...
                    console.log(`  LeetCode: ${lcTotal} problems`);
                }
                ...
                if (student.geeksforgeeksUserName) {
                    ...
                    console.log(`  GFG: ${gfgTotal} problems`);
                }
                ...
                console.log(`  ✅ Saved snapshot for ${student.rollNumber}\n`);

            } catch (err) {
                console.error(`  ❌ Failed for ${student.rollNumber}:`, err, "\n");
            }
